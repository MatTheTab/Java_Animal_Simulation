...
/**
 * Gazelle class, subclass of Prey class, all the functionality remains unchanged from
...
public class Gazelle extends Prey{
     ...
     */
    public Gazelle(int x, int y, JPanel _panel, JLabel name_label, JLabel species_label,
        ...
        super(x, y, NameGenerator.getName(), "Gazelle", GazelleCreator.getStrength(),
                GazelleCreator.getSpeed(), GazelleCreator.getHealth(),
                GazelleCreator.getMaxWaterLevel(), GazelleCreator.getMaxFoodLevel(),
                GazelleCreator.getCurrentWaterLevel(),
                GazelleCreator.getCurrentFoodLevel(), _panel, Converter.pathToImage(GAZELLE_IMAGE_PATH),
                Converter.pathToImage(GAZELLE_SLEEP_IMAGE_PATH), Converter.pathToImage(GAZELLE_WATER_IMAGE_PATH),
                Converter.pathToImage(GAZELLE_FOOD_IMAGE_PATH),Converter.pathToImage(DEAD_ANIMAL_IMAGE_PATH),
                name_label, species_label,health_label,
                strength_label, speed_label, location_label,water_label,food_label,hidden_label,
