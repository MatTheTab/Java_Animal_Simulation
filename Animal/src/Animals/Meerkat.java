...
/**
 * Meerkat class, subclass of Prey class, all the functionality remains unchanged from
 * the parent class. Implemented separately for clarity and convenience sake.
 */
public class Meerkat extends Prey{
    /**
     ...
     */
    public Meerkat(int x, int y, JPanel _panel, JLabel name_label, JLabel species_label,
        ...
        super(x, y, NameGenerator.getName(), "Meerkat", MeerkatCreator.getStrength(),
                MeerkatCreator.getSpeed(), MeerkatCreator.getHealth(),
                MeerkatCreator.getMaxWaterLevel(), MeerkatCreator.getMaxFoodLevel(),
                MeerkatCreator.getCurrentWaterLevel(),
                MeerkatCreator.getCurrentFoodLevel(), _panel, Converter.pathToImage(MEERKAT_IMAGE_PATH),
                Converter.pathToImage(MEERKAT_SLEEP_IMAGE_PATH), Converter.pathToImage(MEERKAT_WATER_IMAGE_PATH),
                Converter.pathToImage(MEERKAT_FOOD_IMAGE_PATH),Converter.pathToImage(DEAD_ANIMAL_IMAGE_PATH),
                name_label, species_label,health_label, strength_label, speed_label, location_label,
                water_label,food_label,hidden_label,
