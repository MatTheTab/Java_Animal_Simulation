...
/**
 * Zebra class, subclass of Prey class, all the functionality remains unchanged from
...
public class Zebra extends Prey{
     ...
     */
    public Zebra(int x, int y, JPanel _panel, JLabel name_label, JLabel species_label,
        ...
        super(x, y, NameGenerator.getName(), "Zebra", ZebraCreator.getStrength(),
                ZebraCreator.getSpeed(), ZebraCreator.getHealth(),
                ZebraCreator.getMaxWaterLevel(), ZebraCreator.getMaxFoodLevel(),
                ZebraCreator.getCurrentWaterLevel(),
                ZebraCreator.getCurrentFoodLevel(), _panel, Converter.pathToImage(ZEBRA_IMAGE_PATH),
                Converter.pathToImage(ZEBRA_SLEEP_IMAGE_PATH), Converter.pathToImage(ZEBRA_WATER_IMAGE_PATH),
                Converter.pathToImage(ZEBRA_FOOD_IMAGE_PATH),Converter.pathToImage(DEAD_ANIMAL_IMAGE_PATH),
